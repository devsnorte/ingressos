defmodule PretexWeb.CustomerLive.TwoFactor do
  use PretexWeb, :live_view

  on_mount({PretexWeb.CustomerAuth, :require_authenticated_no_2fa})
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-md mx-auto py-12">
        ...
        <%= if @totp_enabled do %>
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-4">
            ...
            <.form
              for={@totp_form}
              id="totp-form"
              action={~p"/customers/two-factor/complete"}
              method="post"
        ...
        <div class="mt-6 text-center">
          <.link navigate={~p"/customers/log-out"} class="text-sm text-gray-500 hover:text-gray-700">
  ...
  def mount(_params, _session, socket) do
    ...
    totp_enabled = Customers.Customer.totp_enabled?(customer)
