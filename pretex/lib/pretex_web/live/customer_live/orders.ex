  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-8">
          <h1 class="text-2xl font-bold tracking-tight text-base-content">My Orders</h1>
        ...
        <%= if @orders == [] do %>
          <div class="text-center py-20 space-y-6">
            ...
            <div class="space-y-2">
              <h2 class="text-xl font-semibold text-base-content">No orders yet</h2>
              ...
              >
                ...
                <div class="px-5 py-4 space-y-3">
                  ...
                  <div class="flex items-center justify-between text-sm">
                    <div class="flex items-center gap-2 text-base-content/60">
                      ...
                      <span>
                        ...
                        {if length(order.order_items) == 1, do: "ticket", else: "tickets"}
                      </span>
                    </div>
                  ...
                  <div class="flex items-center gap-2 text-xs text-base-content/40">
                    ...
                    <span>
                      Ordered {Calendar.strftime(order.inserted_at, "%B %d, %Y at %H:%M")}
                    </span>
                  </div>
                </div>
                ...
                <div class="px-5 pb-4">
                  ...
                  >
                    <.icon name="hero-eye" class="size-4" /> View Order Details
                  </.link>
                </div>
              </div>
            <% end %>
