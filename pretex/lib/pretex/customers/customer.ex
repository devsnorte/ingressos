defmodule Pretex.Customers.Customer do
  use Ecto.Schema
  ...
  ## Options
    ...
    * `:validate_unique` - Set to false if you don't want to validate the
      ...
      Defaults to `true`.
  """
  def email_changeset(customer, attrs, opts \\ []) do
    customer
    |> cast(attrs, [:email])
    |> validate_email(opts)
  end
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Pretex.Repo)
  ...
  """
  def valid_password?(%Pretex.Customers.Customer{hashed_password: hashed_password}, password)
